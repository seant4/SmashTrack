            ...
            <CardDeck>
                  <Card>
                    <Card.Body>
                      ...
                      <Card.Text>
                        <ul>
                          <li>Get access to all Smash Utlimate Frame Data and Hit Boxes <a href="https://ultimateframedata.com/">here</a></li>
                          <li>Get access to all Smash Melee Frame Data and Hit Boxes <a href="http://meleeframedata.com/">here</a></li>
                        </ul> 
                      </Card.Text>
